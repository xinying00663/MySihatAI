# Image Direction for Frontend References (formerly `imagegen-frontend-web`)

Elite frontend image-direction module for generating premium, conversion-aware website design reference images. Use this when generating the section reference images that the image-to-code workflow then analyzes and implements. Load before the generation phase of any multi-section website task.
