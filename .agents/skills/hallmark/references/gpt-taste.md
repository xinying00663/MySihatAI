# GPT Taste (formerly `gpt-taste`)

Elite UX/UI & GSAP motion engineering module. Enforces Python-driven true randomization for layout variance, strict AIDA page structure, wide editorial typography (bans 6-line wraps), gapless bento grids, strict GSAP ScrollTriggers (pinning, stacking, scrubbing), inline micro-images, and massive section spacing. Use alongside Hallmark when a brief demands Awwwards-level GSAP choreography.
