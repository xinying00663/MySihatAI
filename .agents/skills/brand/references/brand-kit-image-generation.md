# Brand Kit Image Generation (formerly `brandkit`)

Premium brand-kit image generation: high-end brand-guidelines boards, logo systems, identity decks, and visual-world presentations. Trained for minimalist, cinematic, editorial, dark-tech, luxury, cultural, security, gaming, developer-tool, and consumer-app brand systems. Optimized for intentional logo concepting, refined composition, sparse typography, strong symbolic meaning, premium mockups, art-directed imagery, and flexible grid layouts.

Activate this module when the user wants a generated brand-guidelines board, identity deck, logo concept board, or visual-world presentation image.
